...
import easyocr
my_w = tk.Tk()
my_w.geometry("1280x1096")  # Size of the window 
my_w.title('IMPR Project')
...
l1 = tk.Label(my_w,text='Select any Image',width=30,font=my_font1)  
l1.grid(row=1,column=1)
b1 = tk.Button(my_w, text='Select Image', 
